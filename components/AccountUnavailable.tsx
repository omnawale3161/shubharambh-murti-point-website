...
export function AccountUnavailable({ message = "We could not load your account details right now." }: { message?: string }) {
  return (
    <main className="premium-container py-6 pb-24 md:py-24">
      <section className="premium-card rounded-3xl p-5 md:p-9">
        <div className="flex flex-col gap-5 sm:flex-row sm:items-start">
          ...
          <div>
            ...
            <h1 className="mt-3 text-3xl font-black leading-tight text-primary sm:text-4xl md:text-5xl">Account service unavailable.</h1>
